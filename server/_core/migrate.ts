  ...
  while (retries > 0) {
    try {
      ...
      const columnChecks = [
        ...
        { table: 'payment_sessions', column: 'civilId', definition: 'varchar(20) DEFAULT NULL' },
        { table: 'payment_sessions', column: 'enquiryType', definition: 'varchar(20) DEFAULT NULL' },
