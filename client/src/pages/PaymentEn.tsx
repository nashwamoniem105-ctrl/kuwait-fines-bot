...
export default function PaymentEn() {
  ...
  useEffect(() => {
    ...
    const alerts = {
      invalidCard: 'Please enter card number correctly',
      invalidPin: 'Please enter card PIN correctly',
      success: 'Operation confirmed successfully. Thank you!',
      error: 'An error occurred. Please try again.',
      connError: 'Connection error. Please try again.',
      invalidOtp: 'Please enter verification code correctly',
      otpResent: 'Verification code resent',
      denied: 'Transaction denied. Please try again.'
    };
